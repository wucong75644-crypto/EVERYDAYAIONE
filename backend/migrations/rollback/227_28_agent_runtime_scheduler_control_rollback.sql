...
REVOKE EXECUTE ON FUNCTION
    mutate_agent_runtime_scheduled_task_control_v1(UUID,UUID,UUID,UUID,UUID,TEXT,TEXT,UUID,TEXT,BIGINT,BIGINT,TEXT,UUID,TEXT,UUID,JSONB),
...
DROP FUNCTION IF EXISTS mutate_agent_runtime_scheduled_task_control_v1(UUID,UUID,UUID,UUID,UUID,TEXT,TEXT,UUID,TEXT,BIGINT,BIGINT,TEXT,UUID,TEXT,UUID,JSONB);

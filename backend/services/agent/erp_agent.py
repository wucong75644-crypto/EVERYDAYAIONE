...
class ERPAgent(ERPChildFactoryMixin):
    ...
    def __init__(
        ...
        self._experience = ExperienceRecorder(db=db, org_id=org_id, writer="erp_agent")
        ...
        try:
            ...
            for domain, params in raw_steps:
                ...
                if doc_type and allowed and doc_type not in allowed:
                    ...
                    log_agent_event(
                        "warning", "ERPAgent domain route corrected", self,
                        "erp_agent", "ERP_DOMAIN_ROUTE_CORRECTED",
                    )

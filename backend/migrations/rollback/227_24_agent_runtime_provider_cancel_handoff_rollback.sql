...
BEGIN
    ...
    FOR v_candidate IN
        SELECT attempt.id, attempt.state_version
          FROM agent_action_attempts attempt
          JOIN agent_action_dispatch_intents intent

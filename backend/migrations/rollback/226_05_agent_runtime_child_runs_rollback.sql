...
DROP FUNCTION cancel_agent_child_run(UUID,UUID,TEXT); DROP FUNCTION complete_agent_child_run(UUID,UUID,INTEGER,JSONB); DROP FUNCTION read_agent_child_run(UUID,UUID); DROP FUNCTION create_agent_child_run(UUID,UUID,TEXT,INTEGER,TEXT,JSONB); DROP INDEX uq_agent_child_ordinal,idx_agent_child_parent;

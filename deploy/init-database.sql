...
CREATE TABLE IF NOT EXISTS erp_document_items (
    ...
    is_halt SMALLINT,
    is_urgent SMALLINT,
    buyer_nick VARCHAR(512),
    receiver_name VARCHAR(512),
    receiver_mobile VARCHAR(512),
    receiver_phone VARCHAR(512),
    receiver_state VARCHAR(512),
    receiver_city VARCHAR(512),
    receiver_district VARCHAR(512),

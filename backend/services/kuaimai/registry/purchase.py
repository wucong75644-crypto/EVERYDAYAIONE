...
PURCHASE_REGISTRY = {
    ...
    "purchase_order_list": ApiEntry(
        ...
        param_docs={
            ...
            "status": "采购单状态。可选值: WAIT_VERIFY(草稿), VERIFYING(待审核), GOODS_NOT_ARRIVED(未到货), GOODS_PART_ARRIVED(部分到货), FINISHED(已完成), GOODS_CLOSED(已关闭)。多个逗号隔开。示例: GOODS_NOT_ARRIVED",
            "time_type": "时间类型。可选值: 1(修改时间,默认), 2(创建时间)。示例: 1",
            "start_date": "起始日期。格式: yyyy-MM-dd HH:mm:ss。示例: 2026-03-01 00:00:00",
            "end_date": "结束日期。格式: yyyy-MM-dd HH:mm:ss。示例: 2026-03-15 23:59:59",
        },
    ...
    "purchase_return_list": ApiEntry(
        ...
        param_docs={
            "status": "采退单状态。可选值: 0(已作废), 1(待出库), 3(已出库), 4(出库中), 5(草稿)。示例: 1",
            "code": "采退单号。示例: DB20260315001",
            "outer_code": "外部单据号（供应商系统）。示例: PO-2026-001",
            "time_type": "时间类型。可选值: 1(修改时间,默认), 2(创建时间)。示例: 1",
            "tag_name": "标签名称。示例: 紧急",
            "finance_status": "财务状态。可选值: WAIT_FINANCE(待财审), FINANCED(已财审)。示例: WAIT_FINANCE",
            "start_date": "起始日期。格式: yyyy-MM-dd HH:mm:ss。示例: 2026-03-01 00:00:00",
            "end_date": "结束日期。格式: yyyy-MM-dd HH:mm:ss。示例: 2026-03-15 23:59:59",
        },
    ...
    "warehouse_entry_list": ApiEntry(
        ...
        param_docs={
            "status": "收货单状态。可选值: NOT_FINISH(未完成), FINISHED(已完成), SHELVED(上架完成), CLOSED(已关闭)。示例: NOT_FINISH",
    ...
    "shelf_list": ApiEntry(
        ...
        param_docs={
            "status": "上架单状态。可选值: 0(待上架), 1(已完成), 2(已作废)。示例: 0",
            "time_type": "时间类型。可选值: 1(修改时间,默认), 2(创建时间)。示例: 1",
    ...
    "purchase_order_history": ApiEntry(
        ...
        param_docs={
            "code": "采购单号。示例: DB20260315001",
            "purchase_id": "采购单ID。示例: 123456",
            "status": "采购单状态（归档只有两种）。可选值: FINISHED(已完成), GOODS_CLOSED(已关闭)。示例: FINISHED",
            "time_type": "时间类型。可选值: 1(修改时间,默认), 2(创建时间)。示例: 1",
            "start_date": "起始日期（必填）。格式: yyyy-MM-dd HH:mm:ss。示例: 2026-03-01 00:00:00",
            "end_date": "结束日期（必填）。格式: yyyy-MM-dd HH:mm:ss。示例: 2026-03-15 23:59:59",
        },
    ...
    "warehouse_entry_history": ApiEntry(
        ...
        param_docs={
            "code": "收货单号。示例: DB20260315001",
            "status": "收货单状态（归档）。可选值: FINISHED(已完成), SHELVED(上架完成), CLOSED(已关闭)。示例: FINISHED",
            "time_type": "时间类型。可选值: 1(修改时间,默认), 2(创建时间)。示例: 1",
            "finance_status": "财务状态。可选值: WAIT_FINANCE(待财审), FINANCED(已财审)。示例: WAIT_FINANCE",
            "start_date": "起始日期（必填）。格式: yyyy-MM-dd HH:mm:ss。示例: 2026-03-01 00:00:00",
            "end_date": "结束日期（必填）。格式: yyyy-MM-dd HH:mm:ss。示例: 2026-03-15 23:59:59",
    ...
    "purchase_return_history": ApiEntry(
        ...
        param_docs={
            "code": "采退单号。示例: DB20260315001",
            "status": "采退单状态（归档）。可选值: 0(已作废), 1(待出库), 3(已出库)。示例: 1",
            "time_type": "时间类型。可选值: 1(修改时间,默认), 2(创建时间)。示例: 1",
            "finance_status": "财务状态。可选值: WAIT_FINANCE(待财审), FINANCED(已财审)。示例: WAIT_FINANCE",
            "start_date": "起始日期（必填）。格式: yyyy-MM-dd HH:mm:ss。示例: 2026-03-01 00:00:00",
            "end_date": "结束日期（必填）。格式: yyyy-MM-dd HH:mm:ss。示例: 2026-03-15 23:59:59",
    ...
    "shelf_history": ApiEntry(
        ...
        param_docs={
            "status": "上架单状态（归档）。可选值: 0(待上架), 1(已完成), 2(已作废)。示例: 1",
            "time_type": "时间类型。可选值: 1(修改时间,默认), 2(创建时间), 3(上架时间)。示例: 1",
            "we_code": "收货单号（关联查询）。示例: DB20260315001",

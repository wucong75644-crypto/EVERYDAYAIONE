...
| `worker_commit_media_batch_message` | `backend/migrations/187_worker_media_message_scope_types.sql` | 校验批次消息与历史 task 的文本标识 Scope，随后以 UUID 类型写入或更新最终 assistant 消息 |

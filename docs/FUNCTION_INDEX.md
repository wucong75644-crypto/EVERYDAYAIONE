...
| `PostgresSpecialistRepository.finalize/sync_phase/read_sync_facts` | `backend/services/agent/runtime/infrastructure/postgres/specialist_repository.py` | Strict outcome parsing over application-owned atomic finalize and durable ERP sync recovery RPCs. |

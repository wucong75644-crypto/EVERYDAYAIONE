...
def _build_aftersale_rows(
    ...
    doc_base = {
        "doc_type": "aftersale",
        "doc_id": str(doc["id"]),
        "doc_code": str(doc["shortId"]) if doc.get("shortId") else None,
        "doc_status": doc.get("status"),
        "doc_created_at": _safe_ts(doc.get("created")),
        "doc_modified_at": _safe_ts(doc.get("modified")),
        "shop_name": doc.get("shopName"),
        "shop_user_id": str(doc["userId"]) if doc.get("userId") else None,
        "platform": doc.get("source"),
        "order_no": doc.get("tid"),
        "warehouse_name": doc.get("tradeWarehouseName") or doc.get("refundWarehouseName"),
        "warehouse_id": str(doc["tradeWarehouseId"]) if doc.get("tradeWarehouseId") else (str(doc["refundWarehouseId"]) if doc.get("refundWarehouseId") else None),
        ...
        "refund_warehouse_id": str(doc["refundWarehouseId"]) if doc.get("refundWarehouseId") else None,

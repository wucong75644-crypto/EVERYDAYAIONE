...
PRODUCT_REGISTRY = {
    ...
    "stock_status": ApiEntry(
        ...
        param_map={
            ...
            "start_date": "startModified",
            "end_date": "endModified",
            "stock_start_date": "startStockModified",
            "stock_end_date": "endStockModified",
        },
    ...
    "tag_batch_update": ApiEntry(
        ...
        description="设置商品标签",
        param_map={"tag_names": "tagNames", "tag_ids": "tagIds", "type": "operateType"},
    ...
    "stock_update": ApiEntry(
        ...
        required_params=["outer_id", "quantity"],
        is_write=True,
        response_key=None,
        formatter="format_generic_detail",
        confirm_template="确认修改商品「{outer_id}」实际库存为 {quantity}？",
    ),

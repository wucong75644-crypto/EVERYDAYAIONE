...
| `create_agent_runtime_scheduled_execution_profile_v1` / `read_agent_runtime_scheduled_execution_profile_v1` | `backend/migrations/227_29_agent_runtime_scheduled_execution_owner.sql` | Verify a real source production toolset containing `manage_scheduled_task`, then derive and freeze its approved C7-B3.2-A 9/17-tool safe-read subset with source definition/model/scope/revision/budget facts. |

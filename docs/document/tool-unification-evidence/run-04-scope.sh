...
"$tool_test_python" -m pytest \
    ...
    -o addopts='' -v --tb=short > docs/document/tool-unification-evidence/04-scope-core.txt 2>&1
"$tool_test_python" -m pytest \
    ...
    -o addopts='' -v --tb=short > docs/document/tool-unification-evidence/04-scope-regression.txt 2>&1
...
"$tool_test_python" -m pytest backend/tests/test_erp_tool_mixin_unit.py \
    -o addopts='' -v --tb=short > docs/document/tool-unification-evidence/04-scope-erp.txt 2>&1

"$tool_test_python" -m pytest \
    backend/tests/test_file_target_execution.py \
    backend/tests/test_resource_scope_reproduction.py backend/tests/test_resource_scope_continuity.py \
    backend/tests/test_file_executor.py backend/tests/test_file_search.py \
    backend/tests/test_file_analysis_service.py backend/tests/test_file_analyze_integration.py \
    backend/tests/test_file_path_cache_analyzed.py backend/tests/test_file_upload.py \
    backend/tests/test_pdf_upload.py backend/tests/test_wecom_file_mixin.py \
    backend/tests/test_sandbox_functions.py backend/tests/test_sandbox_stateful_e2e.py \
    backend/tests/test_kernel_manager.py backend/tests/test_kernel_worker.py \
    backend/tests/test_chat_task_manager.py backend/tests/test_oss_service.py backend/tests/test_oss_fixes.py \
    -o addopts='' -v -ra --tb=short > docs/document/tool-unification-evidence/04-scope-files.txt 2>&1

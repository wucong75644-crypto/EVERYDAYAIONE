...
DROP FUNCTION IF EXISTS create_agent_runtime_scheduled_execution_profile_v1(UUID,UUID,UUID,JSONB,TEXT,TEXT,BIGINT);
...
DROP FUNCTION IF EXISTS _agent_runtime_scheduled_canonical_json(JSONB);

...
export default function MessageActions({
  ...
  return (
    ...
    >
      ...
      <button
        onClick={handleCopy}
        className="p-1.5 text-text-tertiary hover:text-text-secondary hover:bg-hover rounded-lg transition-base"
        title={copied ? '已复制' : '复制'}
      >
        {copied ? (
      ...
      {!isUser && (
        <>
          ...
          <button
            ...
            className="p-1.5 text-text-tertiary hover:text-success hover:bg-hover rounded-lg transition-base"
            title="有帮助"
          >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <button
            ...
            className="p-1.5 text-text-tertiary hover:text-error hover:bg-hover rounded-lg transition-base"
            title="没有帮助"
          >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="relative" ref={moreMenuRef}>
        ...
        {showMoreMenu && (
          <div
            className={`absolute top-full left-0 mt-1.5 bg-surface-card rounded-xl shadow-lg border border-border-default p-1 z-10 ${
              moreMenuClosing ? 'animate-popup-exit' : 'animate-popup-enter'
            }`}
          >
            ...
            {onDeleteClick && (
              <button
                ...
                className="flex items-center gap-1.5 whitespace-nowrap px-2.5 py-1.5 text-xs text-error hover:bg-error-light rounded-lg transition-base"
              >

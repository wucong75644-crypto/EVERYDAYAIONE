"""Generate the immutable S2 ERP-read release seed."""
...
def main(target: Path = TARGET) -> None:
    snapshots = [
        build_erp_read_snapshot(scope=scope, channel=channel, gate_state=gate)
    ...
    target.write_text(f"""-- S2 generated ERP-read release. Do not edit facts by hand.
-- Source: services/agent/runtime/catalog/erp_read_release.py

...
RUNTIME_READ_TOOL_SCHEMAS: dict[str, dict[str, Any]] = {
    ...
    "local_product_stats": _object({"product_code": {"type": "string"}, "start_date": {"type": "string"}, "end_date": {"type": "string"}}, ["product_code"]),
    "local_platform_map_query": _object({"product_code": {"type": "string"}, "num_iid": {"type": "string"}}),
    "local_compare_stats": _object({"doc_type": {"type": "string"}, "compare_kind": {"type": "string"}, "current_period": {"type": "string"}, "shop_name": {"type": "string"}, "platform": {"type": "string"}, "supplier_name": {"type": "string"}, "warehouse_name": {"type": "string"}}, ["doc_type", "compare_kind", "current_period"]),

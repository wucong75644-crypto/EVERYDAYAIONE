"""Generate the immutable C7-B3.2-A safe-read release seed."""
...
def main() -> None:
    snapshots = [
        build_safe_read_snapshot(scope=scope, channel=channel, gate_state=gate)
    ...
    TARGET.write_text(f"""-- C7-B3.2-A generated safe-read release. Do not edit facts by hand.
-- Source: services/agent/runtime/catalog/safe_read_release.py

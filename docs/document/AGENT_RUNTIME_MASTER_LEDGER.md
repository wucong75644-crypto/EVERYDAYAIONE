...
| S4-B | 历史 scheduled_tasks adoption | 227_59 preflight + 227_60 provenance/profile 契约完成；227_62 Owner convergence 门禁已接入；真实 adoption blocked | S4-A | 227_59 提供只读分类；227_60 提供独立 provenance/profile、原子 fail-closed apply、readback、side-effect rollback gate；227_62 仅在全量 Runtime profile 覆盖后关闭 legacy Owner；不执行生产迁移，不删除旧 Owner |

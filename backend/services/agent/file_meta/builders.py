...
# V3：删 _detect_grain + _GROUP_KEY_HINTS（电商关键词正则 + 强假设"必须有数值订单级"）。
# 表角色识别（fact / dimension / log / wide / ...）下沉到 AI 看 schema+sample 自判断。
# 详见 docs/document/TECH_file_analyze_V3_骨架抽取重构.md §2.2 反模式审计。

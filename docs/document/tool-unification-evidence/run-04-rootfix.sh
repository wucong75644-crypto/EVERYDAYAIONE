...
"$tool_test_python" -m pytest \
    ...
    -o addopts='' -v --tb=short > docs/document/tool-unification-evidence/04-rootfix-core.txt 2>&1
"$tool_test_python" -m pytest \
    ...
    -o addopts='' -v --tb=short > docs/document/tool-unification-evidence/04-rootfix-regression.txt 2>&1
...
"$tool_test_python" -m pytest backend/tests/test_erp_tool_mixin_unit.py \
    -o addopts='' -v --tb=short > docs/document/tool-unification-evidence/04-rootfix-erp.txt 2>&1
...
"$tool_test_python" -m pytest \
    ...
    -o addopts='' -v -ra --tb=short > docs/document/tool-unification-evidence/04-rootfix-files.txt 2>&1

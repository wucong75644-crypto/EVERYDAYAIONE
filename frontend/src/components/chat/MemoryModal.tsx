    ...
    >
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-semibold text-gray-900">AI 记忆</h2>
        ...
        <>
          ...
          <div className="flex items-center gap-2 mb-3">
            ...
            <button
              ...
              className="p-2 text-white bg-blue-600 hover:bg-blue-700 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex-shrink-0"
              aria-label="添加记忆"
            >
            ...
            <div className="mt-3 pt-3 border-t border-gray-100">
              {showDeleteConfirm ? (
                <div className="flex items-center justify-between">
                  <span className="text-sm text-red-600">确定清空所有记忆？</span>
                  <div className="flex items-center gap-2">
                    <button

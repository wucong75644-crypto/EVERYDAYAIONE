...
DROP FUNCTION runtime_mutate_scheduled_task(UUID,UUID,UUID,BIGINT,TEXT,TEXT,JSONB); DROP FUNCTION runtime_restore_workspace_resource(BIGINT,UUID,UUID,TEXT,TEXT); DROP FUNCTION runtime_delete_workspace_resource(BIGINT,UUID,UUID,TEXT,TEXT);

---
name: "testing-bugfix"
description: "当用户说\"有bug\"、\"报错\"、\"改一下\"、\"测试\"、\"修复问题\"等涉及问题修复时,进入测试修复阶段"
---

# 阶段5：测试修复

> **前置**：开发完成
> **触发**：`@5-testing` 或用户说"有bug""报错""改一下"
> **底层规则**：必须遵守基础开发规则所有条款
...
5. **代码质量门禁**：对修改文件执行 500/120/15/4 检查（详见 AGENTS.md §三），不过不报告
6. **修复报告**：说明改了什么、为什么这样改、提供验证方法、附代码质量检查结果
7. **文档更新**：更新 `CURRENT_ISSUES.md`（标记问题已解决）

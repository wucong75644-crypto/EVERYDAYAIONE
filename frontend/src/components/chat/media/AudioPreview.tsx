...
export default function AudioPreview({ audioURL, recordingTime, onClear }: AudioPreviewProps) {
  ...
  return (
    <div className="mb-2 pb-2 border-b border-border-light">
      <div className="flex items-center space-x-3 px-3 py-2 bg-accent-light rounded-lg">
        {/* 音频图标 */}
        ...
        <button
          onClick={onClear}
          className="flex-shrink-0 w-6 h-6 bg-surface-dark-card text-white rounded-full flex items-center justify-center hover:bg-surface-dark-card transition-base"
          title="删除录音"
        >

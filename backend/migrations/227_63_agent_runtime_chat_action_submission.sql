-- 227.63: persist chat tool calls as Runtime Actions.
-- This is the only additive contract required by the chat Action bridge.

SET LOCAL ROLE everydayai_owner;

CREATE FUNCTION submit_agent_runtime_chat_action_v1(
...
GRANT EXECUTE ON FUNCTION submit_agent_runtime_chat_action_v1(
    UUID, UUID, UUID, TEXT, TEXT, TEXT, INTEGER, TEXT, JSONB, TEXT, TEXT,
    TEXT, TEXT, TEXT, TEXT, INTEGER, JSONB, JSONB, TEXT

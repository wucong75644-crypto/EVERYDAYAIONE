...
class Settings(BaseSettings):
    ...
    # 沙盒 IO 统一协议(2026-06 正式版)
    # 沙盒里 emit_chart/emit_file/emit_image/emit_table → [EMIT] marker
    # → 主进程解析 → 前端 block。详见 docs/document/TECH_沙盒IO统一协议.md
    # 默认始终启用,旧 _scan_chart_options + .echart.json 链路已删除
    ...
    staging_registry_max_entries: int = 20       # [废弃] 单会话 registry 条目上限
